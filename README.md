...
| `@ubeswap/injected-connector`      | [![npm version](https://img.shields.io/npm/v/@ubeswap/injected-connector/latest.svg)](https://www.npmjs.com/package/@ubeswap/injected-connector/v/latest)           | [![minzip](https://img.shields.io/bundlephobia/minzip/@ubeswap/injected-connector/latest.svg)](https://bundlephobia.com/result?p=@ubeswap/injected-connector@latest)           | [Injected](https://github.com/ethereum/EIPs/blob/master/EIPS/eip-1193.md) Connector |
| _Remote API_                          |
